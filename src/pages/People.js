...
import styles from "../stylesheet/films.module.css";
import Card from "../components/CardPeople";
    ...
    <div className={styles.films}>
      ...
      {isGrid && (
        <div className={styles.main}>
          ...
          {data &&
            data.map((curr, index) => {
              return <CardPeople key={index} details={curr} labels={["Name","Date of Birth","Species"]} labels2={["name","birth_year","species"]}/>;
            })}
        </div>
      )}
      {!isGrid && (
